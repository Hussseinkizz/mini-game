...
// node_modules/z-js-framework/src/rendering/render-functions.js
function render(parentElement, componentFunction) {
  parentElement.innerHTML = "";
  parentElement.appendChild(componentFunction());
}

// node_modules/z-js-framework/src/utils/utilities.js
...
// node_modules/z-js-framework/src/rendering/css.js
...
// node_modules/z-js-framework/src/libs/morphdom-esm@v2.7.3.js
...
var morphdom_esm_v2_7_3_default = morphdom;

// node_modules/z-js-framework/src/rendering/html.js
var trackedStates = /* @__PURE__ */ new Set();
...
function updateDom(fromNode, toNode, options = {}) {
  ...
  morphdom_esm_v2_7_3_default(fromNode, toNode, finalOptions);
}
function List(props) {
  let list_id = generateUniqueId("LIST");
  const { ref, items, render: render3 } = props;
  ...
  const renderList = (target) => {
    if (target) {
      ...
      _items.forEach((item, index) => {
        const childElement = render3({ item, index });
        target.innerHtml = "";
...
// node_modules/z-js-framework/src/hooks/useSuspense.js
...
// node_modules/z-js-framework/src/store/state-radio/lib/state-radio.js
...
// node_modules/z-js-framework/src/store/index.js
var { channels } = StateRadio();
var radio = channels;
...
// node_modules/z-js-framework/src/routing/router.js
var ZLink = class extends HTMLElement {
  constructor() {
    super(...arguments);
...
function Router(config2 = {}) {
  const parent = config2.parent || document.body;
  const routes = config2.routes || [];
  const initialDelay = config2.initialDelay || 0;
...
// node_modules/z-js-framework/src/fetch/z-fetch/index.js
var defaultConfig = {
  baseUrl: "",
  bearerToken: null,
  timeout: 9e4,
...
// node_modules/z-js-framework/index.js
var _router = null;
var _parentElement = null;
var render2 = (parentElement = null, routes = [], initialDelay = 0) => {
  if (!parentElement) {
  ...
  render(parentElement, initialRoute.component);
...
var useRouter = () => _router;
var getRootElement2 = () => _parentElement;
export {
  DELETE,
  GET,
  List,
  ...
  css,
  getRef,
  getRootElement2 as getRootElement,
  html,
  radio,
  reactive,
  render2 as render,
...
//# sourceMappingURL=z-js-framework.js.map
